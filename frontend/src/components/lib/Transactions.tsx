...
import { BadgeAlert, Library, X } from "lucide-react";
  ...
  return (
    ...
    >
      <div className="mx-auto mt-8 flex max-w-[--header-max-w] flex-col items-center md:items-end">
        <div className="w-[90vw] max-w-[25rem] rounded-[24px] bg-gray-300 px-6 py-8 text-text-primary shadow-popover-shadow md:ml-auto md:mr-[3rem] md:max-w-[30rem] md:p-8">
