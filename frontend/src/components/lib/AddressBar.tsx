  ...
  return (
    ...
    >
      <div className="user-modal mx-auto flex w-full max-w-[--header-max-w] flex-col items-center py-8 md:items-end md:px-12">
        <div className="flex w-[90vw] max-w-[25rem] flex-col justify-between gap-4 rounded-[24px] bg-black p-8 text-md text-white shadow-popover-shadow transition-colors duration-500 ease-linear md:max-w-[30rem]">
  ...
  return (
    <>
      <button
        ...
        className="rounded-full bg-black px-2 py-1 text-accent-secondary md:px-4 md:py-2"
      >
        {
